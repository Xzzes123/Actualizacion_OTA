...
#define CURRENT_VERSION "1.0.1"  // Versión actual del firmware
const char* updateJsonURL = "https://xzzes123.github.io/Actualizacion_OTA/firmware.json";
const char* serverUrl = "https://0ca2-187-161-118-115.ngrok-free.app/api/track";
...
bool enviarEvento(Evento evento) {
  ...
  String payload = "{\"id_bin\":\"10\",\"bssid\":\"" + bssid + "\", \"status\":\"" + evento.status + "\"}";
